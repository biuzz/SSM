...
public class TestParamController {
    ...
    @RequestMapping("/parm/servletAPI")
    ...
    @RequestMapping("/parm")
    public String gerParam(@RequestParam(value = "userName",required = true,defaultValue ="hello") String username,
                           String password,
